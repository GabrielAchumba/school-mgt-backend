...
func (module *userModule) RegisterRoutes(rg *gin.RouterGroup, tokenMaker token.Maker) {
	...
	moduleRoute.Use(middleware.AuthMiddleware(tokenMaker))
	{
		...
		moduleRoute.GET("/paginatedusers/:schoolId/:page", serverHttp(module.controller.GetPaginatedUnconfirmedUsers))
		moduleRoute.GET("/paginatedconfirmesusers/:schoolId/:page", serverHttp(module.controller.GetPaginatedConfirmedUsers))
